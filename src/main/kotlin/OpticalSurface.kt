...
class OpticalSurface(
    private val surface: Surface, private val refractionIndex: Float
) : (Ray) -> Ray {
    override operator fun invoke(ray: Ray): Ray {
        ...
        return Ray(
            intersection.point, Refraction.instance(ray.direction, intersection.direction, refractionIndex)
        )
    }
    ...
    companion object {
        ...
        fun makeSphericalRefractor(sphericalSection: SphericalSection, refractionIndex: Float) =
            OpticalSurface(sphericalSection, refractionIndex)
    }
}
